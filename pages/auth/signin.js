        ...
        <div className='w-full' >
            ...
            {Object.values(providers).map(provider => (
                <div key={provider.name}>
                    <form>
                        <button
                            className="flex items-center max-w-sm font-light hover:font-normal hover:bg-cool-gray-100 shadow-md appearance-none border rounded w-full py-2 px-3 text-gray-600 leading-tight focus:outline-none focus:shadow-outline" type="button"
